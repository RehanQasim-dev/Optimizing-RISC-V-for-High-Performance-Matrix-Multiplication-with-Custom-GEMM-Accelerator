...
riscv64-unknown-elf-gcc -c -o build/main.o src/uart_rx.c -march=rv32imzicsr -mabi=ilp32
riscv64-unknown-elf-gcc -o build/main.elf build/startup.o build/main.o -T linker.ld -nostdlib -march=rv32imzicsr -mabi=ilp32 -O0  # Example: use -O0 for optimization level 2
